...
class DataPathWarning(UserWarning):
    """Warnings regarding the classification_data path."""


DEFAULT_DATA_DIR = os.path.expanduser('~/.classification_data/UEA_UCR')
UEA_UCR_DATA_DIR = 'classification_data/UEA'

if UEA_UCR_DATA_DIR == DEFAULT_DATA_DIR:
    warnings.warn(
        'Using default classification_data path "{}". You can change this by setting '
...
#     warnings.warn(
#         'The classification_data path "{}" does not exist. All funcitons in this module will '
...
def _build_UEA_UCR_data_path(name, train):
    ...
    Args:
        ...
        train: If True returns path to train classification_data, otherwise to test classification_data
...
class Dataset(Sequence):
    ...
    def __init__(self, name, data_dir=UEA_UCR_DATA_DIR, train=True):
        """Datasets from the UCR time series archiv.
        ...
        """
        global UEA_UCR_DATA_DIR
        UEA_UCR_DATA_DIR = data_dir
